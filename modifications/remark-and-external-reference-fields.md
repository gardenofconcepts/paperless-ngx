...
**File**: `src/documents/migrations/1066_correspondent_external_reference_and_more.py`
...
- Updated `MatchingModelSerializer` to include `remark` field
...
- Clicking the icon shows the remark content in a popover
...
- Migration `1066` is required to update the database schema
